...
const StyledWrapper = styled.div`
  .earth-loader {
    --watercolor: #fff; /* خلفية بيضاء */
    --landcolor: #4E9C1F; /* أخضر شعار المشروع */
    width: 7.5em;
    height: 7.5em;
    ...
    border-radius: 50%;
    box-shadow:
      inset 0em 0.5em rgb(78, 156, 31, 0.08),
      inset 0em -0.5em rgb(204, 0, 0, 0.08);
    border: solid 0.15em #4E9C1F;
